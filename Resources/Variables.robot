...
${UPLOAD_ID}   class:fw-file-upload-input
${UTILITY_TYPE}  id:msf-text-utility-bill-type
${NAME_UTILITY_FIELD}  id:msf-text-name-on-utility-bill
${ADDRESS_ON_UTILITY}  id:msf-textarea-address-on-utility
${DATE_UTILITY}  id:msf-date-date-on-utility
${UPLOAD_UTILITY_BILL}  id:fw-2-3-2-4
${TEST_QUESTION_CURRENT}  xpath://select[@id='msf-select-test-question']
${TEST_ANSWER_CURRENT}  xpath://input[@id='msf-text-test-answer']
${FOUTH_NEXT_BTN_CURRENT}  xpath://button[@class='fw-button-next']
${PASSPORT_UPLOAD_CURRENT}  xpath://input[@id='fw-2-4-0-0']
${SIGNED_SIGNATURE_CURRENT}  xpath://input[@id='fw-2-4-0-1']
${REFERENCE1_NAME}  id:msf-text-full-name-of-reference-1
${OCCUPATION_REFERENCE1}  id:msf-text-occupation
${ADDRESS_REFERENCE1}   xpath://*[@id="msf-textarea-address"]
${PHONENUMBER_REFERENCE1}   xpath://body/div[@id='wrap_all']/div[@id='main']/div[1]/div[1]/main[1]/div[1]/div[1]/div[1]/section[1]/div[1]/div[1]/div[3]/div[1]/div[5]/div[2]/div[2]/div[4]/div[1]/input[1]
${ACCOUNT_NUMBER_REFERENCE1}  xpath://body/div[@id='wrap_all']/div[@id='main']/div[1]/div[1]/main[1]/div[1]/div[1]/div[1]/section[1]/div[1]/div[1]/div[3]/div[1]/div[5]/div[2]/div[2]/div[5]/div[1]/input[1]
${SIGNATURE_UPLOAD_REFERENCE1}  xpath://div[@class='fw-wizard-step fw-current']//div[6]//input[@class='fw-file-upload-input']
${REFERENCE2_NAME}  id:msf-text-full-name-of-reference-2
${OCCUPATION_REFERENCE2}  xpath://body/div[@id='wrap_all']/div[@id='main']/div[1]/div[1]/main[1]/div[1]/div[1]/div[1]/section[1]/div[1]/div[1]/div[3]/div[1]/div[5]/div[2]/div[2]/div[8]/div[1]/input[1]
${ADDRESS_REFERENCE2}  xpath://div[@class='fw-wizard-step fw-current']//div[9]//textarea[@id='msf-textarea-address']
${PHONENUMBER_REFERENCE2}  xpath://body/div[@id='wrap_all']/div[@id='main']/div[1]/div[1]/main[1]/div[1]/div[1]/div[1]/section[1]/div[1]/div[1]/div[3]/div[1]/div[5]/div[2]/div[2]/div[10]/div[1]/input[1]
${ACCOUNT_NUMBER_REFERENCE2}  xpath://body/div[@id='wrap_all']/div[@id='main']/div[1]/div[1]/main[1]/div[1]/div[1]/div[1]/section[1]/div[1]/div[1]/div[3]/div[1]/div[5]/div[2]/div[2]/div[11]/div[1]/input[1]
${SIGNATURE_UPLOAD_REFERENCE2}  xpath://input[@id='fw-2-4-1-11']
${SUBMIT_APPLICATION}  xpath://button[@class='fw-btn-submit']
